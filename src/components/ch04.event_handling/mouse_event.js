        ...
        <div className="App">
            ...
            <table>
                <tbody>
                    <tr>
                        <td>
                            <img src={`${image_path}/french_baguette_01.png`} alt="프렌티 바게트" width={image_small_size} height={image_small_size}
                    ...
                    <tr>
                        <td>
                            <img src={`${image_path}/croissant_02.png`} alt="크로아상" width={image_small_size} height={image_small_size}
                                onMouseMove={MouseMoveEvent} />
                        </td>
                    </tr>
                    <tr>
